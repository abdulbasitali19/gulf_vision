frappe.ui.form.on('Material Request', {
    ...
    refresh: function (frm) {
        frm.add_custom_button(__('Approved'), function () {
            frappe.call({
                method: "gulf_vision.overrides.material_request.Accepting_from_custom_approver_material_request",
                args: {
        ...
        frm.add_custom_button(__('Reject'), function () {
            frappe.call({
                method: "gulf_vision.overrides.material_request.Rejecting_from_custom_approver_material_request",
                args: {
                    material_request: frm.doc.name
                },
                callback: function (r) {
